...
jQuery('#list2').jqGrid({
	...
	onSelectRow: function (ids) {
		...
		jQuery('#list3').jqGrid('setGridParam', {url: route + 'controller/server/knt/getcontrakts.php?idknt=' + ids});
		jQuery('#list3').jqGrid('setGridParam', {editurl: route + 'controller/server/knt/getcontrakts.php?idknt=' + ids});
		jQuery('#list3').jqGrid({
