...
if ($user->isAdmin()):
	...
	<div class="container-fluid">
		<div class="row">
			<form role="form" id="myForm" enctype="multipart/form-data" action="route/deprecated/server/users/libre_users_form.php?step=edit&id=<?= $id; ?>" method="post" name="form1" target="_self">
